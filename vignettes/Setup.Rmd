...
You also choose to save it into your .Rprofile to save the key between R session.
...
The .Rprofile file is an R script that is launch each time R starts. Sometimes they
