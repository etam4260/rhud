...
stateId: If type is 2-5, you must specify the state fips code from 0-56.

entityId: If type is 3-5, you must specify either the county, mcd, or place, respectively.
...
This is a basic example showing you how to query the Comprehensive Housing and Affordability API.

This function returns a single row dataframe.
...
hud_chas(type = '2', stateId ='56', year = '2014-2018')[,c(1,2,3,4,5,6,7,8,9)]
```

### Data Fields

I recommend checking out https://www.huduser.gov/portal/dataset/chas-api.html for more
details as the fields return require some level of domain knowledge.
