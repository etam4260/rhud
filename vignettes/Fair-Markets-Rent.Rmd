...
If you only need the state level data, then this might work better...
...
If you need just metropolitan data...
...
|          Can provide either a 10 digit FIPS code which is almost always
