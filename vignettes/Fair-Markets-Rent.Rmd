...
```{r, echo=FALSE, fig.cap="Small wooden house with coin stack on white background by wuestenigel is licensed under CC BY 2.0.", out.width = '50%'}
knitr::include_graphics("./fmr_pic.jpg")
```
