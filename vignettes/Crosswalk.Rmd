...
it should make up 100% consisting of (for example) 37% from 3513, 45% from
13132, and 18% from 22411.

QUERY: Depending on the type selected, 1-5 must specify a zip code. 6 must
specify a tract. 7 must specify a county fip. 8-9 must specify a cbsa code. 10
must specify a county district code. 11 must be a zip code. 12 must be a county
sub district.
