...
4) [zip-cbsadiv (Available 4th Quarter 2017 onwards)][Converting zipcode to core based statistical area division(cbsadiv)]
...
```
### Converting zipcode to core based statistical area division(cbsadiv)
```{r, eval = if(Sys.getenv("HUD_KEY") == "")  FALSE else TRUE}
