# Should allow user to provide county name/state names/abbreviations.
# All string inputs that can be numeric inputs can be supplied as a numeric input.
test_that("Crosswalk All Types", {
  ...
  tract_zip = hud_cw(type = 6, query = '48201223100',
                                   year = c('2017', '2010'), quarter = c('1','2','3'))
  ...
  # User might not provide a 'set' of years or quarters, so should make sure to check that
  # Sometimes the API might not provide data because out of range years.
  # Also testing Countysub _> ZIP
  # STATE = 46
  # COUNTY = 067
  # SUB = 20300
...
test_that("Crosswalk Different Years", {
  ...
  expect_error(hud_cw(type = 7, query = '22031',
                                year = c('2010', '2011', '2024'), quarter = c('1','2','3','4')))
})
...
test_that("Not Convertable to Integer", {
  ...
  expect_error(hud_cw(type = '7', query = '22031ad',
                                   year = c('2010', '2011'), quarter = c('1','2','3','4')))

  expect_error(hud_cw(type = '7', query = '22031',
                                   year = c('2010', '2011d'), quarter = c('1','2','3','4')))

  expect_error(hud_cw(type = 7, query = '22031',
                                   year = c('2010', '2011'), quarter = c('1','2as','3','4')))
})
